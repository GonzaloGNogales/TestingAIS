...
public class Request {
	...
	public Request(long idCustomer, long idProduct, long productCost, int getProductCostValue, int withdrawProductValue, int reserveCreditValue, int notifyValue, int saveValue) {
	...
	public Request(long idCustomer, long idProduct, long productCost, int getProductCostValue, int withdrawProductValue, int reserveCreditValue, int notifyValue, int saveValue, String message) {
		this.idCustomer = idCustomer;
		this.idProduct = idProduct;
		this.productCost = productCost;
		this.getProductCostValue = getProductCostValue;
	...
	public Request(long idCustomer, long idProduct, int statusAPI, String idAPI, int idValue, String message, String messageAPI) {
		this.idCustomer = idCustomer;
		this.idProduct = idProduct;
